...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("serialized_state", postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    ...
    op.create_table(
        ...
        sa.UniqueConstraint("session_id", "turn_index", name="uq_agent_turn_session_turn_index"),
    )
    ...
    op.create_table(
        ...
        sa.Column("status", tool_execution_status, nullable=False, server_default="started"),
        ...
        sa.UniqueConstraint("session_id", "run_id", name="uq_tool_execution_session_run_id"),
    )
    op.create_index("ix_tool_executions_session_id", "tool_executions", ["session_id"], unique=False)
    op.create_index("ix_tool_executions_agent_turn_id", "tool_executions", ["agent_turn_id"], unique=False)
